...
def get_args():
    ...
    parser.add_argument("--input", type=str, default="test_images/pedestrian.jpeg")
    parser.add_argument("--output", type=str, default="output_imgs/pedestrian_prediction_yolov3.jpg")
